                ...
                <div class="wrap wpt">
                    ...
                    <form class="mt-8" method='post' action='' name='myform' enctype='multipart/form-data'>
                        <div class="w-64 flex flex-wrap items-center justify-center bg-grey-lighter">
                            <label class="w-full flex flex-col items-center px-4 py-6 mb-4 bg-white text-blue rounded-lg shadow-lg tracking-wide uppercase transition border border-blue-500 cursor-pointer hover:bg-blue-500 hover:text-white">
                            ...
                            <input class="w-full button button-primary rounded-lg p-2 text-xl text-center" type='submit' name='submit_upload' value='Загрузить файл CSV'>
                        </div>
                    </form>
                </div>
                <?php
